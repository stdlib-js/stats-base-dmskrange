...
```javascript
import dmskrange from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-dmskrange@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/stats-base-dmskrange/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/stats-base-dmskrange/actions/workflows/test.yml?query=branch:v0.1.0
